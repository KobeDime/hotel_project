  ...
  <div class="container-fluid my-4">
    <div class="row">
      <div class="col-lg-12 p-4">
        ...
        <div class="row mb-4">
          <div class="col-md-3 mb-4">
            <a href="new_bookings.php" class="text-decoration-none">
              <div class="card text-center text-success p-3 custom-card">
                <h6>New Bookings</h6>
          ...
          <div class="col-md-3 mb-4">
            <a href="refund_bookings.php" class="text-decoration-none">
              <div class="card text-center text-warning p-3 custom-card">
          ...
          <div class="col-md-3 mb-4">
            <a href="user_queries.php" class="text-decoration-none">
              <div class="card text-center text-info p-3 custom-card">
                <h6>User Queries</h6>
        ...
        <div class="row mb-3">
          <div class="col-md-3 mb-4">
            <div class="card text-center text-primary p-3 custom-card">
          ...
          <div class="col-md-3 mb-4">
            <div class="card text-center text-danger p-3 custom-card">
